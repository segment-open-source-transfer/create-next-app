...
exports.cloneRepoHelp = function() {
  return `Clones a specified GitHub repo as your starting-point.`
}
...
exports.exampleOrClone = function() {
  return `Please specify the "example" option OR the "clone repo" option (but not both)`
}
